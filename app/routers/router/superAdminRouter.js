...
superAdminRouter
    ...
    .post('/api/superAdmin/changeProjectName',superAdminController.changeProjectName)
    .post('/api/superAdmin/terminateProject',superAdminController.terminateProject)
